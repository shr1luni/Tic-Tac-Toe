...
public class TicTacToe extends JFrame implements ActionListener {
    ...
    // moveCounter- holds the number of moves made in the game
    private int xScore, oScore, moveCounter;

    // isPlayerOne is a boolean variable - flag to indicate if the current player is
    // x or not
    ...
    private void addGuiComponent() {
        ...
        turnLabel.setBounds(
                (CommonConstants.FRAME_SIZE.width - turnLabel.getPreferredSize().width) / 2, 0,
        ...
        boardPanel.setBounds(0, scoreLabel.getY() + scoreLabel.getPreferredSize().height + 20,
    ...
    private void checkDraw() {
        // if there is a total of 9 moves and no player has won yet then it means there
        // is a draw
        if (moveCounter >= 9) {
